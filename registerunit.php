<?php
    ...
    if(isset($_POST['register'])){
      ...
      if($username_ada > 0)
      {
        ...
        document.location='registerunit.php'
        </script>
        <?php
      }
      else {
        $adddata1 = $unit->add_data($kd_unit, $nama_unit, $kp_unit);
                  ...
                  <br/>
                    <form method="post">
                      <div class="form-group">
                          ...
                          <input name="nama_unit" type="text" class="form-control" placeholder="Nama Unit">
                      </div>
                      <div class="form-group">
                          <label>Kepala Unit</label>
                          <input name="kp_unit" type="text" class="form-control" placeholder="Kepala Unit">
                      </div>
                        <div class="form-group">
