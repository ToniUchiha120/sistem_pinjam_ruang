...
if (isset($_POST['login'])) {
  ...
  if($check){
    ...
    if($_SESSION['pengguna']['level']=='organisasi')
    {
      ?>
      <script type="text/javascript">
      alert ('Selamat Datang di Halaman Organisasi');
      document.location='halamanorganisasi/index.php'
      </script>
      <?php
    }
    else if ($_SESSION ['pengguna']['level'] == 'unit') {
    ?>
    <script type="text/javascript">
    alert ('Selamat Datang di Halaman Unit');
    document.location='halamanunit/index.php'
    </script>
    <?php
   }
    else if ($_SESSION ['pengguna']['level'] == 'baak') {
      ?>
      <script type="text/javascript">
      alert ('Selamat Datang di Halaman BAAK');
      document.location='halamanbaak/index.php'
      </script>
      <?php
    }
    else if ($_SESSION ['pengguna']['level'] == 'baup') {
      ?>
      <script type="text/javascript">
      alert ('Selamat Datang di Halaman BAUP');
      document.location='halamanbaup/index.php'
      </script>
      <?php
    }
    }
